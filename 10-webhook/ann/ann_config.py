...
class Config(object):
  ...
  # AWS SNS topics
  AWS_SNS_RESULTS_ARN = "arn:aws:sns:us-east-1:127134666975:mariagabrielaa_a13_job_results"

  # AWS SQS queues
  AWS_SQS_WAIT_TIME = 20
  AWS_SQS_MAX_MESSAGES = 10
  AWS_SQS_QUEUE_NAME = "mariagabrielaa_a13_job_requests"
  AWS_SQS_QUEUE_URL = "https://sqs.us-east-1.amazonaws.com/127134666975/mariagabrielaa_a13_job_requests"
