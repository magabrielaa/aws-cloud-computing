  ...
  # (3) If the SNS message type is a notification, poll the archive queue
    ...
    if len(messages) > 0:
      for message in messages:
        ...
        # If message doesn't contain job_id, message cannot be processed and is deleted
        if "job_id" not in msg_body:
          print("Message does not contain required job_id parameter")
          try:
            message.delete()
        ...
        # Otherwise, process the message
          ...
          # (8) If user role is free, proceed to archive
            ...
            # (8.5) Delete results file from S3 bucket
